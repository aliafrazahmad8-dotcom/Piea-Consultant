...
import com.piea.student.ui.screens.support.HelpSupportScreen
import com.piea.student.ui.screens.support.FAQScreen
import com.piea.student.ui.screens.support.SupportFormScreen
import com.piea.student.ui.screens.support.SocialMediaScreen
        ...
        NavHost(
            ...
            composable(Screen.HelpSupport.route) {
                HelpSupportScreen(
                    ...
                    onComplaint = { navController.navigate(Screen.Complaint.route) },
                    onWhatsApp = { navController.navigate(Screen.WhatsAppSupport.route) },
            ...
            composable(Screen.Feedback.route) {
                SupportFormScreen(type = "Feedback", onBack = { navController.popBackStack() })
            }

            composable(Screen.Complaint.route) {
                SupportFormScreen(type = "Complaint", onBack = { navController.popBackStack() })
            }
